      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="mb-4 md:mb-0">
            <h3 className="text-2xl font-bold text-primary">NeuNotes</h3>
            <p className="text-sm mt-2 text-gray-300 max-w-sm">
              A collaborative platform for sharing academic notes and enhancing learning through peer-to-peer knowledge exchange.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="mailto:contact@neunotes.com" className="text-gray-300 hover:text-primary transition-colors">
                  Contact Us
                </a>
              </li>
              <li>
