      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex md:items-center md:space-x-4">
            ...
            {user ? (
              <>
                <Link to="/profile" className="text-white hover:text-accent px-3 py-2 rounded-md text-sm font-medium">
                  Profile
                </Link>
                
                {user.role === 'ADMIN' && (
                  <Link to="/admin" className="text-white hover:text-accent px-3 py-2 rounded-md text-sm font-medium">
                    Admin Dashboard
                  </Link>
                )}
                ...
                <div className="ml-4 flex items-center space-x-4">
                  ...
                  <button
                    ...
                    className="text-sm bg-primary hover:bg-accent px-3 py-1 rounded"
                  >
                    Logout
                  </button>
                </div>
              ...
              <div className="space-x-4">
                ...
                <Link to="/signup" className="text-sm bg-primary hover:bg-accent px-3 py-1 rounded">
                  Sign Up
                </Link>
              </div>
            )}
          ...
          {user ? (
            <>
              ...
              <div className="px-3 py-2">
                ...
                <div className="text-xs bg-primary inline-block px-2 py-1 rounded mt-1">
                  {user.role}
                </div>
              </div>
              ...
              <button
                ...
                className="text-white hover:text-accent block w-full text-left px-3 py-2 rounded-md text-base font-medium"
              >
                Logout
              </button>
            </>
