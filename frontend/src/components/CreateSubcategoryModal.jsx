// src/components/CreateSubcategoryModal.jsx
import React, { useState } from 'react';
import api from '../services/api';

const CreateSubcategoryModal = ({ isOpen, onClose, categoryId, onSuccess }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold text-secondary">Add New Subcategory</h2>
          <button
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              placeholder="e.g., Lecture Notes, Assignments, etc."
              required
            />
          </div>
