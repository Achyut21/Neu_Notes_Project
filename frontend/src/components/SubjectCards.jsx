...
const SubjectCard = ({ category, onDelete, currentUser }) => {
  // Check if user can delete this category
  const canDelete = currentUser && (
    currentUser.role === 'ADMIN' || 
    (currentUser.role === 'FACULTY' && currentUser.id === category.created_by)
  );
...
const SubjectCards = ({ categories, onDelete, currentUser }) => {
  return (
